...
您使用本服务器即表示同意以下条款：
  ...
  2. 您有责任确保您的使用符合所有适用法律、法规及百度学术、OpenAlex、
     Crossref 等数据源的服务条款。
  3. 百度学术为非官方抓取接口，可能违反百度学术 robots.txt；建议优先
     使用 OpenAlex 与 Crossref（官方开放接口）。
  4. 高频访问可能被临时封禁，请设置合理的请求间隔（默认 ≥2 秒）。
  5. 下载的论文版权归原作者及出版商所有，使用时须遵守著作权法。
  6. 本项目作者及维护者对使用本服务器产生的任何法律后果不承担任何责任。
